...
class BackendConfigTests(unittest.TestCase):
    def test_resolve_backend_config_defaults_to_local_mode(self) -> None:
        ...
        self.assertEqual(config["state_index_governance_role"], "local-governance-ledger")
        self.assertEqual(config["state_index_truth_boundary"], "lifecycle-and-relationships-not-content-truth")
        self.assertEqual(config["retrieval_role"], "core-semantic-retrieval")
        self.assertEqual(config["retrieval_truth_boundary"], "findability-not-trust-or-content-truth")
    ...
    def test_resolve_backend_config_accepts_hybrid_cloud_overrides(self) -> None:
        ...
        self.assertEqual(config["state_index_governance_role"], "shared-governance-ledger")
        self.assertEqual(config["state_index_truth_boundary"], "lifecycle-and-relationships-not-content-truth")
        self.assertEqual(config["retrieval_role"], "core-semantic-retrieval")
        self.assertEqual(config["retrieval_truth_boundary"], "findability-not-trust-or-content-truth")
